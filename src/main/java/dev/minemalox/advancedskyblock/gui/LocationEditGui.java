...
import dev.minemalox.advancedskyblock.gui.buttons.ButtonColorWheel;
import dev.minemalox.advancedskyblock.gui.buttons.ButtonLocation;
import dev.minemalox.advancedskyblock.gui.buttons.ButtonResize;
...
public class LocationEditGui extends GuiScreen {
    ...
    public LocationEditGui(dev.minemalox.advancedskyblock.AdvancedSkyblock main, int lastPage, EnumUtils.GuiTab lastTab) {
        this.main = main;
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        ...
        if (resizing) {
            ...
            if (this.editMode == EditMode.RESIZE_BARS) {
                ...
                buttonLocation.drawButton(mc, mouseX, mouseY, 0.0f); // TODO: right?
                recalculateResizeButtons();
            }
