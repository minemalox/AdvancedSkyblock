...
public class ButtonSettings extends ButtonFeature {
    ...
    private static ResourceLocation GEAR = new ResourceLocation("advancedskyblock", "gear.png");
     ...
     */
    public ButtonSettings(double x, double y, String buttonText, AdvancedSkyblock main, Feature feature) {
