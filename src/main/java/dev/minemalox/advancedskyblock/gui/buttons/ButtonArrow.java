...
public class ButtonArrow extends GuiButton {
    ...
    private static ResourceLocation ARROW_RIGHT = new ResourceLocation("advancedskyblock", "arrowright.png");
    private static ResourceLocation ARROW_LEFT = new ResourceLocation("advancedskyblock", "arrowleft.png");
     ...
     */
    public ButtonArrow(double x, double y, AdvancedSkyblock main, ArrowType arrowType, boolean max) {
