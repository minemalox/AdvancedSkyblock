...
public class CheckBox {
    ...
    public void draw() {
        ...
        AdvancedSkyblock.getInstance().getUtils().drawTextWithStyle(text, scaledX + Math.round(size * 1.5f / scale), scaledY + (size / 2), color);
    ...
    public void onMouseClick(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0
            ...
            value = !value;
            AdvancedSkyblock.getInstance().getUtils().playSound(SoundEvents.UI_BUTTON_CLICK, 0.25, 1);
