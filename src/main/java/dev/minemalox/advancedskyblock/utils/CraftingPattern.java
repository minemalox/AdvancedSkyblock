...
public enum CraftingPattern {
    ...
    public static final ResourceLocation ICONS = new ResourceLocation("advancedskyblock", "craftingpatterns.png");
        ...
        for (int i = 0; i < pattern.length; i++) {
            ...
            if (isSlotInPattern(i)) {
                if (hasStack) {
                    ...
                    diff.add(itemStack.getMaxStackSize() - itemStack.getCount());
                } else {
