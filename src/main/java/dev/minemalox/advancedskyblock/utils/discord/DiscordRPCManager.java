...
public class DiscordRPCManager implements IPCListener {
    ...
    public DiscordRPCManager(final AdvancedSkyblock main) {
        this.main = main;
    }
    ...
    public void updatePresence() {
        Location location = AdvancedSkyblock.getInstance().getUtils().getLocation();
        SkyblockDate skyblockDate = AdvancedSkyblock.getInstance().getUtils().getCurrentDate();
