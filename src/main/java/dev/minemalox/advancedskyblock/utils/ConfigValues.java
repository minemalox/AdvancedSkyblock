...
public class ConfigValues {
    ...
    public static float normalizeValueNoStep(float value) {
        return MathHelper.clamp((snapNearDefaultValue(value) - ConfigValues.GUI_SCALE_MINIMUM) /
...
//                featureColors.put(feature, ChatFormatting.values()[ordinal]);
    ...
    public void loadLanguageFile(boolean pullOnline) {
        ...
        if (pullOnline)
            tryPullingLanguageOnline(language); // try getting an updated version online after loading the local one
    }
